  ...
  return (
    <div>
      <h5 className=' p-1 text-center w-[95%] absolute top-0 '>
        <i className="ri-arrow-down-s-line text-gray-200 text-3xl cursor-pointer" onClick={() => {
          props.setConfirmRidePanelOpen(false)
        }}></i>
      </h5>
      <h3 className="text-2xl font-semibold mt-3 ">Confirm your Ride</h3>
      ...
      <div className='flex gap-2 items-center flex-col justify-between'>
        ...
        <button onClick={() => {
          ...
          props.setConfirmRidePanelOpen(false)
        }} className='w-full mt-5 text-white font-semibold p-2 rounded-lg  bg-green-500'>Confirm Ride</button>
      </div>
